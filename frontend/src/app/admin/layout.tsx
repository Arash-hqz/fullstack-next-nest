// ===== File: README.md =====
// Admin Dashboard scaffold for Next.js (App Router) + TypeScript + Tailwind + shadcn/ui
// Features:
// - Responsive sidebar + topbar layout
// - Dashboard with stats cards and charts (recharts)
// - CRUD pages for Articles, Products, Projects, Users (list / edit / delete / create)
// - Theme switch (light/dark)
// - Protected route wrapper placeholder (useAuth)
// - API service wrapper ready for replacing mocks with real endpoints
//
// How to use:
// - Copy each file into your project (paths shown as comments)
// - Install dependencies: react, next, tailwindcss, framer-motion, lucide-react, recharts, shadcn-ui, axios
// - Replace mock fetches in services/adminApi.ts with your real endpoints
// - Wire auth (useAuth) to your backend when ready
...
/* ==================================================================
   ...
   - Simple theme context using localStorage
   ================================================================== */
...
/* ==================================================================
   ...
   - API wrapper with mock & placeholder for real endpoints
   ================================================================== */
...
/* ==================================================================
   ...
   - Admin Dashboard home: stats cards + mini charts
   ================================================================== */
...
/* ==================================================================
   ...
   - Articles list with CRUD actions (mocked)
   ================================================================== */
...
/* ==================================================================
   ...
   - Article edit/view page (simple)
   ================================================================== */


/* ==================================================================
   File: src/app/admin/products/page.tsx
   - Products list (similar structure). Repeat pattern for Projects/Users
   ================================================================== */
...
/* ==================================================================
   Notes:
   - This scaffold focuses on frontend pages and components, ready to call real APIs via adminApi.
   - Replace mock implementations in adminApi with axios/fetch calls to your NestJS backend.
   - Add authentication middleware/guards on backend to protect admin endpoints.
   - Install dependencies: lucide-react, recharts, axios, framer-motion
   ================================================================== */
